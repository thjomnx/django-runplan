...
urlpatterns = patterns('runplan.views',
    ...
    url(r'^activity/last/$', 'activity_last'),
    url(r'^shouts/$', 'shouts'),
    url(r'^shouts/last/$', 'shouts_last'),
    url(r'^shouts/create/$', 'shout_create'),
    url(r'^create/$', 'create'),
    url(r'^(?P<runplan_id>\d+)/$', 'detail'),
    url(r'^(?P<runplan_id>\d+)/edit/$', 'edit'),
    url(r'^(?P<runplan_id>\d+)/cancel/$', 'cancel'),
    url(r'^(?P<runplan_id>\d+)/recreate/$', 'recreate'),
    url(r'^(?P<runplan_id>\d+)/attend/$', 'attend'),
    url(r'^(?P<runplan_id>\d+)/revoke/$', 'revoke'),
    url(r'^(?P<runplan_id>\d+)/observe/$', 'observe'),
    url(r'^(?P<runplan_id>\d+)/forget/$', 'forget'),
